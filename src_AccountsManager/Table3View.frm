VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Table3View 
   Caption         =   "[Titel]"
   ClientHeight    =   6360
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   6120
   OleObjectBlob   =   "Table3View.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Table3View"
...
Attribute Create.VB_Description = "A factory method to create new instances of this View, already wired-up to a ViewModel."
    GuardClauses.GuardNonDefaultInstance Me, Table3View, TypeName(Me)
    
    Dim result As Table3View
    Set result = New Table3View
